        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <i data-feather="grid"></i>
                    <span data-key="t-dashboard">Course Category</span>
                </a>
            </li>
            ...
            <li>
                ...
                <i data-feather="book"></i>
                    <span data-key="t-dashboard">Course</span>
                </a>
            </li>
            ...
            <li>
                ...
                <i data-feather="users"></i>
                    <span data-key="t-dashboard">Students</span>
                </a>
            </li>
            ...
            <li>
                <a href="index.html">
                <i data-feather="users"></i>
                    <span data-key="t-dashboard">Instructors</span>
                </a>
            </li>

            <li>
                <a href="index.html">
                    <span data-key="t-dashboard">Exam</span>
                </a>
            </li>

            <li>
                <a href="index.html">
                    <span data-key="t-dashboard">Question Bank</span>
                </a>
            </li>

            <li>
                <a href="index.html">
                    <span data-key="t-dashboard">Enrollment</span>
                </a>
            </li>
            ...
            <li>
                <a href="index.html">
                    <span data-key="t-dashboard">Package & Pricing</span>
                </a>
            </li>
